        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThai_ThanhToan = table.Column<bool>(type: "bit", nullable: false),
                    TrangThai_DonHang = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Dh_ChiTiet", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Dh_ChiTiet_DonHang_DonHangId",
                        column: x => x.DonHangId,
                        principalTable: "DonHang",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Dh_ChiTiet_Product_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dh_ChiTiet_DonHangId",
                table: "Dh_ChiTiet",
                column: "DonHangId");

            migrationBuilder.CreateIndex(
                name: "IX_Dh_ChiTiet_ProductId",
                table: "Dh_ChiTiet",
                column: "ProductId");
